...
echo ""
echo "#############################################################"
echo "# Install Shadowsocks-Python server script                  #"
echo "# Intro: https://yang.nz/                                   #"
echo "# Author: jerryliu2000 <info@yang.nz>                       #"
echo "# Reference: https://github.com/teddysun/                   #"
echo "#############################################################"
echo ""
...
function checkos(){
    if [ -f /etc/redhat-release ];then
        ...
        echo "Not support linux OS, Please reinstall OS from "CenotOS,Debian,Ubuntu" and retry!"
        exit 1
    fi
}
...
function pre_install(){
    ...
    echo "Please input password for shadowsocks-python server:"
    read -p "(Default password:yang.nz):" shadowsockspwd
    [ -z "$shadowsockspwd" ] && shadowsockspwd="yang.nz"
    echo ""
    echo "---------------------------"
...
function download_files(){
    if [ "$OS" == 'CentOS' ]; then
        ...
        if ! wget --no-check-certificate https://raw.githubusercontent.com/jerryliu2000/ss/master/shadowsocks-debian -O /etc/init.d/shadowsocks; then
            echo "Failed to download shadowsocks chkconfig file!"
            exit 1
        fi
    fi
